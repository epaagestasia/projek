<footer id="footer" class="footer dark-background">
  ...
  <script src="{{ asset('/') }}Bootslanderassets/vendor/purecounter/purecounter_vanilla.js"></script>
  <script src="{{ asset('/') }}Bootslanderassets/vendor/swiper/swiper-bundle.min.js"></script>
